#if 0
// Disabled: demo code not used by the wifi-tamagotchi build.
// Keeping the file (but excluding from compilation) avoids Arduino IDE
// pulling in extra dependencies (SD, BLE, LVGL demos, etc.).
